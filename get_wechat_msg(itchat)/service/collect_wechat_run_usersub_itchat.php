...
require_once(dirname(__FILE__) ."/wechat_collect/ZkWechatCollectUsersubItchat.php");
...
//print_r(zk_simple_get_block_info(700001));exit;
...
//实例化前对$_REQUEST进行兼容处理
$str = file_get_contents('php://input');
$array = json_decode($str,true);
unset($_REQUEST);
$_REQUEST['list']['list'] = $array['data'];
$_REQUEST['list']['biz'] = $array['biz'];
$_REQUEST['list'] =json_encode($_REQUEST['list']);
$_REQUEST['list'] = decodeUnicode($_REQUEST['list']);
...
$obj = new ZkWechatCollectUsersubItchat();
$obj->come_from = 'weixin_itchat';
